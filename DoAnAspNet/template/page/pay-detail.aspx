<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="pay-detail.aspx.cs" Inherits="DoAnAspNet.template.page.pay_detail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-5 mb-5" id="hidediv">
        ...
        <div class="row">
			<section class="ftco-section" style="text-align: center; margin-top: -90px;">
                <a href="javascript:genPDF()">Download PDF</a>
				<button type="button" class="btn btn-primary" onclick="printPDF()">In hóa đơn</button>
