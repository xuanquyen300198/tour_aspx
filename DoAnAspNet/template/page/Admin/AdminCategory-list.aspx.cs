...
{
    public partial class AdminCategory_list : System.Web.UI.Page
    {
        ...
        {
            Session["ma_danh_muc_edit"] = null;
            objFilter = new OBFilter();
            objFilter.limit = 10;
            objFilter.offset = 0;
            lstDanhMuc = (List<DanhMuc>)danhMucsController.GetDanhMucBySearch(objFilter);
            count = danhMucsController.CountDanhMucBySearch(objFilter);
            if (count > 10)
            {
                totalPage = count / 10;
            }
            ...
            repeater.DataSource = lstDanhMuc;
            repeater.DataBind();
