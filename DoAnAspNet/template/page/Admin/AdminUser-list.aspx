<%@ Page Title="" Language="C#" MasterPageFile="~/template/page/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AdminUser-list.aspx.cs" Inherits="DoAnAspNet.template.page.Admin.AdminUser_list" %>
                        ...
                        <asp:Repeater ID="repeater" runat="server" OnItemCommand="repeater_ItemCommand">
                            <ItemTemplate>
                                <tr class="even gradeC">
                                    <td style="text-align:center"><%# Eval("ma") %></td>
                                    <td style="text-align:center"><%# Eval("username") %></td>
                                    <td style="text-align:center"><%# Eval("ten") %></td>
                                    <td style="text-align:center"><%# Eval("quyen").ToString()=="1" ? "Admin" : (Eval("quyen").ToString()=="2" ? "Quản trị viên" : "Nhân viên") %></td>
                                    <td>
