<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="book-tour.aspx.cs" Inherits="DoAnAspNet.template.page.book_tour" %>
                  ...
                  <section class="bui-card bp-card--booking-summary">
                     <div class="bui-card__content">
                        <header class="bui-card__header">
                           <h2 class="bui-card__title">Chi tiết đặt tour của bạn</h2>
                        </header>
                                    ...
                                    <div class="bui-group__item">
                                       <div class="bui-group bui-group--medium">
                                          <div class="bui-group__item">
                                             ...
                                             <h1 id="bp-property-details__title" class="bui-card__title bui-text--variant-headline_3 bp-property-details__name js-property-details__name e2e-property-details__name"><%=tour.ten %></h1>
                                          </div>
                                          <div class="bui-group__item">
