<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="about-us.aspx.cs" Inherits="DoAnAspNet.template.page.about_us" %>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item active"><a href="about-us.aspx" class="nav-link">About</a></li>
                    <li class="nav-item"><a href="tour.aspx" class="nav-link">Tour</a></li>
                    <li class="nav-item"><a href="hotel.aspx" class="nav-link">Hotels</a></li>
