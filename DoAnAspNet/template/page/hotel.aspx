<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="hotel.aspx.cs" Inherits="DoAnAspNet.template.page.hotel" %>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
                    <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.aspx">Trang chủ</a></span> <span>Khach sạn</span></p>
                    <h1 class="mb-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Danh sách khách sạn</h1>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <form action="#">
                            <div class="fields">
                                <div class="form-group">
                                    <asp:TextBox runat="server" ID="textSearch" class="form-control" placeholder="Khách sạn" />
                                </div>
                                <div class="form-group">
